...
EGIT_REPO_URI="https://github.com/hsudbrock/java-ebuilder"
KEYWORDS="amd64"

inherit java-pkg-2 java-pkg-simple prefix git-r3

DESCRIPTION="Java team tool for semi-automatic creation of ebuilds from pom.xml - fork by hsudbrock"
